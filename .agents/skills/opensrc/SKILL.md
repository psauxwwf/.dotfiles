...
# Fetch package (auto-detects installed version from lockfile)
opensrc zod

# Fetch from other registries
opensrc pypi:requests       # Python/PyPI
opensrc crates:serde        # Rust/crates.io

# Fetch GitHub repo directly
opensrc vercel/ai           # owner/repo shorthand
opensrc github:owner/repo   # explicit prefix
opensrc https://github.com/colinhacks/zod  # full URL
...
opensrc zod pypi:pydantic vercel/ai
```
