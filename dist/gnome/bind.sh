...
gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-1 "['<Super>grave', '<Super>Cyrillic_shorti']"
...
gsettings set org.gnome.desktop.wm.keybindings move-to-workspace-1 "['<Super><Shift>grave', '<Super><Shift>Cyrillic_shorti']"
