...
gsettings set org.gnome.desktop.wm.keybindings move-to-workspace-1 "['<Super><Shift>grave', '<Super><Shift>ё']"
...
gsettings set org.gnome.desktop.wm.keybindings close "['<Super>й', '<Super>q']"
